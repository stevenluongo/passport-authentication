...
export default function Register() {
  ...
  //hooks
  const { isProcessing, setIsProcessing, isGithubProcessing, setIsGithubProcessing, setUser } = useAuth();
  ...
  const validateInputValues = ({username, email_address, password}) => {
    ...
    if(!validateEmail(email_address)) throw new Error("Please provide a valid email address");
